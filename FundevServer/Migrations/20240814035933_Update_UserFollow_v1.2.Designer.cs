...
namespace FundevServer.Migrations
{
    ...
    [Migration("20240814035933_Update_UserFollow_v1.2")]
    partial class Update_UserFollow_v12
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FundevServer.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FundevServer.Data.UserFollow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FundevServer.Data.UserFollow", b =>
                {
                    b.HasOne("FundevServer.Data.ApplicationUser", "Follower")
                        .WithMany("Following")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FundevServer.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
